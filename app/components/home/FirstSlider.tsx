      ...
      <div className="relative">
        <div className="flex flex-row overflow-x-hidden snap-x snap-mandatory" ref={scrollRef}>
          <article className="snap-end flex-none w-full relative">
            ...
            <button
              className={`text-black absolute top-1/3 right-4 flex ${currentIndex !== 0 ? "hidden" : "block"}`}
          ...
          <article className="snap-end flex-none w-full relative">
            ...
            <button
              className={`text-black absolute top-1/3 left-4 flex ${currentIndex === 0 ? "hidden" : "block"}`}
