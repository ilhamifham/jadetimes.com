...
import ResetPassword from "@/app/components/authform/ResetPassword";
  ...
  return (
    <div className="max-w-[640px] md:w-[308px] mx-auto">
      {isResetPassword ? (
        ...
        <>
          <div className="font-medium text-heading text-center text-4xl">Log In</div>
          <div className="text-sm text-center my-4">
            New to this site ?{" "}
            <button className="underline font-medium text-heading" onClick={handleLogInOff}>
              Sign In
            </button>
          </div>
