  ...
  return (
    <footer className="border-t border-t-neutral-900 text-neutral-900">
      <div className="max-w-[1376px] mx-auto p-4">
        <div className="mt-6 mb-5 lg:flex lg:flex-row lg:justify-between lg:mt-10 lg:mb-14">
          <div className="mb-4 lg:mb-0">
            ...
            <div className="text-sm flex flex-row items-center justify-center max-w-lg mx-auto whitespace-nowrap border-t border-t-neutral-300 pt-4 lg:text-xs lg:border-none lg:pt-0 lg:mt-3">
              <Link href="/advertise-with-us" className="lg:hover:underline">
                Advertise with us
              </Link>
              <span className="w-[1px] h-3 bg-neutral-900 mx-2"></span>
              <Link href="/talk-to-us" className="lg:hover:underline">
                Talk to us
              </Link>
            </div>
          </div>
        ...
        <nav className="hidden border-t border-b border-neutral-300 py-4 text-[#515151] xl:flex xl:items-center xl:justify-center xl:gap-3 lg:block">
          <ul className="text-xs flex flex-row items-center justify-center gap-3 flex-wrap font-semibold">
            {navigationPaths.slice(1, 13).map((path) => (
              <li key={path.key} className="gap-4">
                <Link href={path.to} className="inline-block duration-300 hover:underline">
                  {path.name}
                </Link>
              </li>
            ))}
            {navigationPaths[1].submenus?.slice(0, 5).map((submenu) => (
              <li key={submenu.key} className="gap-4">
                <Link href={submenu.to} className="inline-block duration-300 hover:underline">
                  {submenu.name}
                </Link>
              </li>
            ))}
          </ul>
          <ul className="flex flex-row gap-3 w-full justify-center text-lg mt-3 xl:w-auto xl:justify-normal xl:mt-0">
            <li className="flex">
        ...
        <div className="flex flex-col items-center lg:mt-4 lg:gap-4 xl:flex-row xl:justify-between">
          <div className="text-xs lg:text-[0.6875rem] mb-6 text-nowrap lg:order-2 xl:order-none lg:mb-0">
            &copy; 2024 Jadetimes Media LLC. <span className="inline-block xl:block">All Rights Reserved</span>
          </div>
          <ul className="hidden lg:flex flex-row flex-wrap justify-center text-[0.6875rem] xl:justify-normal xl:max-w-[66.45rem]">
            <li>
              <Link href="/terms-and-conditions" className="duration-300 hover:underline">
                Terms & Conditions
              </Link>
            ...
            <li>
              <Link href="/privacy-policy" className="duration-300 hover:underline">
                Privacy Policy
              </Link>
              <span className="mx-2">|</span>
            </li>
            <li>
              <Link href="/careers" className="duration-300 hover:underline">
            ...
            <li>
              <Link href="/advertise-with-us" className="duration-300 hover:underline">
                Get Published Online Articles
              </Link>
              <span className="mx-2">|</span>
            </li>
            <li>
              <Link href="/accessibility" className="duration-300 hover:underline">
                Accessibility Help
              </Link>
              <span className="mx-2">|</span>
            </li>
            <li>
              <Link href="/faq" className="duration-300 hover:underline">
                FAQ
              </Link>
              <span className="mx-2">|</span>
            </li>
            ...
            <li>
              <Link href="mailto:info@jadetimes.com" className="duration-300 hover:underline">
                info@jadetimes.com
              </Link>
              <span className="mx-2">|</span>
            </li>
            ...
            <li>
              <Link href="/blog" className="duration-300 hover:underline">
                Blog
              </Link>
              <span className="mx-2">|</span>
            </li>
            <li>
              The JadeTimes holds no responsibility for the content of external websites. For more information, please review our policy on external
              linking.
            </li>
          </ul>
        </div>
