...
const ThirdSlider = ({ articles, className }: Props) => {
  ...
  return (
    <div className={`relative h-[800px] max-w-[2520px] mx-auto ${className}`}>
      <div
        className="flex flex-col overflow-y-hidden h-[800px] relative snap-y snap-mandatory"
        onTouchStart={handleTouchStart}
        onTouchEnd={handleTouchEnd}
      >
        {articles.map((article, index) => (
          <article
            className={`w-full bg-center bg-cover bg-no-repeat absolute z-0 snap-start duration-1000 ease-in-out ${
          ...
          >
            ...
            <div className="bg-gradient-to-t from-black to-transparent relative">
