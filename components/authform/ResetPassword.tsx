...
const ResetPassword = ({ handleResetPasswordOff }: { handleResetPasswordOff: () => void }) => {
  return (
    <>
      ...
      <div className="text-sm text-center">
        Back to{" "}
        <button className="underline font-medium text-heading" onClick={handleResetPasswordOff}>
          Log In
        </button>
      </div>
    </>
